...
- ﻿오토 스케일링 그룹이 업데이트된 것을 알 수 있음

*클라우드 트레일이란?

[출처](https://dthumb-phinf.pstatic.net/?src=%22https://tech.cloud.nongshim.co.kr/wp-content/uploads/2018/10/%25EC%259D%25B4%25EB%25AF%25B8%25EC%25A7%2580-36-3.jpg%22&type=ff120)

- AWS 계정 활동, 작업, 리소스 사용 등 사용자의 활동을 지속적으로 모니터링하여 S3에 로그 기록을 저장해주는 서비스

- 따라서 EC2 생성 등 리소스 관리, 변경사항을 기록하므로 AWS 아키텍처 구성시 클라우드 트레일을 먼저 구성해야함
